...
uint8_t ov2640_init(void)
{
    ...
    /* 使能时钟 */
    OV_PWDN_GPIO_CLK_ENABLE();                              /* 使能OV_PWDN引脚端口时钟 */
    OV_RESET_GPIO_CLK_ENABLE();                             /* 使能OV_RESET引脚端口时钟 */
    OV_FLASH_GPIO_CLK_ENABLE();                             /* 使能OV_FLASH引脚端口时钟 */
    
    /* 配置OV_PWDN引脚 */
    gpio_init_struct.Pin = OV_PWDN_GPIO_PIN;                /* OV_PWDN引脚 */
    gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;            /* 通用推挽输出模式 */
    gpio_init_struct.Pull = GPIO_PULLUP;                    /* 上拉 */
    gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH;          /* 高速 */
    HAL_GPIO_Init(OV_PWDN_GPIO_PORT, &gpio_init_struct);    /* 配置OV_PWDN引脚 */
    
    /* 配置OV_RESET引脚 */
    gpio_init_struct.Pin = OV_RESET_GPIO_PIN;               /* OV_RESET引脚 */
    gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;            /* 通用推挽输出模式 */
    gpio_init_struct.Pull = GPIO_PULLUP;                    /* 上拉 */
    gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH;          /* 高速 */
    HAL_GPIO_Init(OV_RESET_GPIO_PORT, &gpio_init_struct);   /* 配置OV_RESET引脚 */
    
    /* 配置OV_FLASH引脚 */
    gpio_init_struct.Pin = OV_FLASH_GPIO_PIN;               /* OV_FLASH引脚 */
    gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;            /* 通用推挽输出模式 */
    gpio_init_struct.Pull = GPIO_PULLUP;                    /* 上拉 */
    gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH;          /* 高速 */
